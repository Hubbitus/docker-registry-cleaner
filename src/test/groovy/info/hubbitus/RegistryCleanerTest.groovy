...
Tag=[bp-app:dev-588e886                              ]; time=[2018-02-27T15:48:39.036452851Z[UTC]]; isForDelete=[true ]; [KeepDecision(keepTagOption:null, keepByTop:false, keepByPeriod:false)]
Tag=[bp-app:dev-877e771                              ]; time=[2018-02-28T07:11:49.883955591Z[UTC]]; isForDelete=[true ]; [KeepDecision(keepTagOption:null, keepByTop:false, keepByPeriod:false)]
Tag=[bp-app:dev-634c014                              ]; time=[2018-02-28T07:39:53.730091859Z[UTC]]; isForDelete=[true ]; [KeepDecision(keepTagOption:null, keepByTop:false, keepByPeriod:false)]
Tag=[bp-app:dev-92a66b5                              ]; time=[2018-02-28T14:31:24.896067239Z[UTC]]; isForDelete=[true ]; [KeepDecision(keepTagOption:null, keepByTop:false, keepByPeriod:false)]
Tag=[bp-app:dev-9fb6481                              ]; time=[2018-03-02T10:23:15.754942986Z[UTC]]; isForDelete=[true ]; [KeepDecision(keepTagOption:null, keepByTop:false, keepByPeriod:false)]
Tag=[bp-app:fix-index-master-f120510                 ]; time=[2018-02-05T07:29:28.547081017Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(GLOBAL), tagRegexp:.*, top:5, period:604800, periodStr:1w), keepByTop:true, keepByPeriod:false)]
Tag=[bp-app:RR-137-4aa15f1                           ]; time=[2018-02-11T00:54:19.826086077Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(GLOBAL), tagRegexp:.*, top:5, period:604800, periodStr:1w), keepByTop:true, keepByPeriod:false)]
Tag=[bp-app:RR-137-f9cd2da                           ]; time=[2018-02-11T23:03:29.789979902Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(GLOBAL), tagRegexp:.*, top:5, period:604800, periodStr:1w), keepByTop:true, keepByPeriod:false)]
Tag=[bp-app:RR-137-78909c9                           ]; time=[2018-02-11T23:17:20.728198209Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(GLOBAL), tagRegexp:.*, top:5, period:604800, periodStr:1w), keepByTop:true, keepByPeriod:false)]
Tag=[bp-app:RR-163-19a1ed5                           ]; time=[2018-02-13T11:44:27.182739119Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(GLOBAL), tagRegexp:.*, top:5, period:604800, periodStr:1w), keepByTop:true, keepByPeriod:false)]
...
Tag=[bp-app:RR-441-SIA_2-6109e2c                     ]; time=[2018-02-28T07:39:21.023391353Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(GLOBAL), tagRegexp:.*, top:5, period:604800, periodStr:1w), keepByTop:false, keepByPeriod:true)]
Tag=[bp-app:RR-156_EV_due_date_control-41f63f2       ]; time=[2018-02-28T12:55:02.707215949Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(GLOBAL), tagRegexp:.*, top:5, period:604800, periodStr:1w), keepByTop:false, keepByPeriod:true)]
Tag=[bp-app:RR-414-68887c6                           ]; time=[2018-02-28T13:27:42.441952270Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(GLOBAL), tagRegexp:.*, top:5, period:604800, periodStr:1w), keepByTop:false, keepByPeriod:true)]
Tag=[bp-app:RR-414-f987bf0                           ]; time=[2018-02-28T13:42:42.692044426Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(GLOBAL), tagRegexp:.*, top:5, period:604800, periodStr:1w), keepByTop:false, keepByPeriod:true)]
Tag=[bp-app:0.1.3-400d522                            ]; time=[2018-03-02T12:24:13.442968508Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(GLOBAL), tagRegexp:.*, top:5, period:604800, periodStr:1w), keepByTop:false, keepByPeriod:true)]
...
Tag=[bp-app:dev-fe77a06                              ]; time=[2018-01-24T13:27:28.463593716Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(bp-app), tagRegexp:^dev-, top:5), keepByTop:true, keepByPeriod:false)]
Tag=[bp-app:dev-692a89c                              ]; time=[2018-02-05T09:22:02.091675529Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(bp-app), tagRegexp:^dev-, top:5), keepByTop:true, keepByPeriod:false)]
Tag=[bp-app:dev-5525b4a                              ]; time=[2018-02-05T12:37:51.913028654Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(bp-app), tagRegexp:^dev-, top:5), keepByTop:true, keepByPeriod:false)]
Tag=[bp-app:dev-f29e6a6                              ]; time=[2018-02-13T09:04:01.554640731Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(bp-app), tagRegexp:^dev-, top:5), keepByTop:true, keepByPeriod:false)]
Tag=[bp-app:dev-447820d                              ]; time=[2018-02-13T09:14:53.281537159Z[UTC]]; isForDelete=[false]; [KeepDecision(keepTagOption:KeepOption$KeepTagOption(parent:KeepOption(bp-app), tagRegexp:^dev-, top:5), keepByTop:true, keepByPeriod:false)]
